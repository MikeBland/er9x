...
const prog_char APM Str_telemItems[] = "\004----A1= A2= RSSITSSITim1Tim2Alt GaltGspdT1= T2= RPM FUELMah1Mah2CvltBattAmpsMah CtotFasVAccXAccYAccZ" ; 
...
#if GVARS
						md2->weight = gvarMenuItem( 7*FW+FW/2, y, md2->weight, -125, 125, attr ) ;
#else
