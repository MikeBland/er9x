...
#define AUDIO_FRSKY_WARN1 (0)
#define AUDIO_FRSKY_WARN2 (1)
#define AUDIO_FRSKY_CHEEP (2)
#define AUDIO_FRSKY_RING (3)
#define AUDIO_FRSKY_SCIFI (4)
#define AUDIO_FRSKY_ROBOT (5)
#define AUDIO_FRSKY_CHIRP (6)
#define AUDIO_FRSKY_TADA (7)
#define AUDIO_FRSKY_CRICKET (8)
#define AUDIO_FRSKY_SIREN (9)
